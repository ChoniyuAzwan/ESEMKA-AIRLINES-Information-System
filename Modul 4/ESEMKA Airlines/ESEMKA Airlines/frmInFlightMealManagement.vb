...
Public Class frmInFlightMealManagement
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If Q = vbYes Then
            Try
                ...
                With Cmd
                    .Connection = Con
                    .CommandText = "delete mealmanagement where menu  = '" & dgvData.SelectedRows(0).Cells(0).Value & "'"
                    R = .ExecuteNonQuery
                End With
                If R > 0 Then
    ...
    Private Sub frmInFlightMealManagement_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ShowData()
            ...
            If dgvData.Columns(i).Visible Then
                If dgvData.Columns(i).HeaderText = cbTitle.SelectedItem Then
                    Try
                        ...
                        With Cmd
                            .Connection = Con
                            .CommandText = "select * from mealmanagement where " & dgvData.Columns(i).Name & " like '%" & txtSearch.Text & "%'"
                        End With
                        Da.SelectCommand = Cmd
                        Dt.Clear()
                        Da.Fill(Dt)
