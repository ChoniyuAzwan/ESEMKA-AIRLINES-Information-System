...
Public Class frmeditflightscheduling
    Sub FillData()
        Try
            OpenDB()
            With Cmd
                .Connection = Con
                .CommandText = "select * from scheduling where flightnumber = '" & frmFlightScheduling.dgvData.SelectedRows(0).Cells(0).Value & "'"
                Dr = .ExecuteReader
            End With
            While Dr.Read
                TextBox6.Text = Dr(0)
                ...
                TextBox8.Text = Dr(6)
                ComboBox1.SelectedItem = Dr(7)
                ComboBox2.SelectedItem = Dr(8)
                TextBox5.Text = Dr(9)
                TextBox7.Text = Dr(10)
                TextBox3.Text = Dr(11)
            End While
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            With Cmd
                .Connection = Con
                .CommandText = "select * from scheduling where flightnumber = '" & TextBox6.Text & "' and flightnumber <> '" & frmFlightScheduling.dgvData.SelectedRows(0).Cells(0).Value & "'"
            End With
        ...
        Try
            ...
            With Cmd
                .Connection = Con
                .CommandText = "update scheduling set FlightNumber = '" & TextBox6.Text & "', FlightOrigin = '" & TextBox1.Text & "', FlightDestination =  '" & TextBox2.Text & "', DepartureSchedule = '" & DateTimePicker1.Text & "', DepartureTime = '" & TextBox4.Text & "', ArrivalSchedule = '" & DateTimePicker2.Text & "', ArrivalTime = '" & TextBox8.Text & "', AirplaneType = '" & ComboBox1.Text & "', TripPoint = '" & ComboBox2.Text & "', FlightPrice = '" & TextBox5.Text & "', Duration = '" & TextBox7.Text & "' , BoardingRoom = '" & TextBox3.Text & "' where flightnumber = '" & frmFlightScheduling.dgvData.SelectedRows(0).Cells(0).Value & "'"
                R = .ExecuteNonQuery
            End With
            If R > 0 Then
            ...
            frmInformationBroadcast.ShowDialog()
        Catch ex As Exception
            Err(ex.Message)
